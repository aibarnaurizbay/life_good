...
void _taskSerialize(
  ...
  writer.writeLong(offsets[5], object.pointsReward);
...
Task _taskDeserialize(
  ...
  object.pointsReward = reader.readLong(offsets[5]);
...
extension TaskQueryFilter on QueryBuilder<Task, Task, QFilterCondition> {
  ...
  QueryBuilder<Task, Task, QAfterFilterCondition> pointsRewardEqualTo(
      int value) {
    return QueryBuilder.apply(this, (query) {
      return query.addFilterCondition(FilterCondition.equalTo(
        property: r'pointsReward',
        value: value,
      ));
    });
  }

  QueryBuilder<Task, Task, QAfterFilterCondition> pointsRewardGreaterThan(
    int value, {
    bool include = false,
  }) {
    return QueryBuilder.apply(this, (query) {
  ...
  QueryBuilder<Task, Task, QAfterFilterCondition> pointsRewardLessThan(
    int value, {
    bool include = false,
  }) {
    return QueryBuilder.apply(this, (query) {
  ...
  QueryBuilder<Task, Task, QAfterFilterCondition> pointsRewardBetween(
    int lower,
    int upper, {
    bool includeLower = true,
    bool includeUpper = true,
...
extension TaskQuerySortBy on QueryBuilder<Task, Task, QSortBy> {
  ...
  QueryBuilder<Task, Task, QAfterSortBy> sortByPointsReward() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'pointsReward', Sort.asc);
    });
  }

  QueryBuilder<Task, Task, QAfterSortBy> sortByPointsRewardDesc() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'pointsReward', Sort.desc);
    });
  }
...
extension TaskQuerySortThenBy on QueryBuilder<Task, Task, QSortThenBy> {
  ...
  QueryBuilder<Task, Task, QAfterSortBy> thenByPointsReward() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'pointsReward', Sort.asc);
    });
  }

  QueryBuilder<Task, Task, QAfterSortBy> thenByPointsRewardDesc() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'pointsReward', Sort.desc);
    });
  }
...
extension TaskQueryWhereDistinct on QueryBuilder<Task, Task, QDistinct> {
  ...
  QueryBuilder<Task, Task, QDistinct> distinctByPointsReward() {
    return QueryBuilder.apply(this, (query) {
      return query.addDistinctBy(r'pointsReward');
    });
  }
...
extension TaskQueryProperty on QueryBuilder<Task, Task, QQueryProperty> {
  ...
  QueryBuilder<Task, int, QQueryOperations> pointsRewardProperty() {
    return QueryBuilder.apply(this, (query) {
      return query.addPropertyName(r'pointsReward');
    });
  }
